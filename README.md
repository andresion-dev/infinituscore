...
O exemplo a seguir cria um registro com o nome relativo "www" na Zona DNS "infinituscore.com", no grupo de recursos **"rg-ntier"**. O nome totalmente qualificado do conjunto de registros é **"www.infinituscore.com"**. O tipo de registro é "A", com o endereço IP do application gateway e um TTL padrão de 3.600 segundos (1 hora).
