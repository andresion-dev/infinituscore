#!/bin/bash
          ...
          az network vnet subnet update \
            ...
            --resource-group $resourceGroup 
            --network-security-group $nsgBusiness
          ...
          az network vnet subnet update \
            ...
            --name "$subnetDataName" \
            --resource-group "$resourceGroup" \
            --network-security-group $nsgData
          ...
          az network vnet subnet update \
            ...
            --name "$subnetADDSName" \
            --resource-group "$resourceGroup" \
            --network-security-group $nsgADDS
